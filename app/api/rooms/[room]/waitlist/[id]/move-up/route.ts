...
export async function POST(
  ...
  try {
    ...
    // Move the waitlist entry up
    WaitlistPositionManager.setSupabaseClient(supabase)
    const success = await WaitlistPositionManager.moveUp(id)
    ...
    console.error('Error moving waitlist entry up:', error)
    return NextResponse.json(
